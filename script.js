document.addEventListener('DOMContentLoaded', async () => {
    ...
    window.removePostFromAllViews = function(postId) {
        ...
        const reelPost = document.querySelector(`.reel-container[data-id="${postId}"]`) || document.querySelector(`.reel-item[data-id="${postId}"]`);
        if(reelPost) reelPost.remove();
        
        const profilePost = document.querySelector(`.profile-grid-item[data-id="${postId}"]`);
