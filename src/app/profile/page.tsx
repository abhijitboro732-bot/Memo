...
import {
  ...
  UserPlus, UserCheck, ExternalLink, Trash2, Video, Upload, LogOut, Moon, Bell, Shield, HelpCircle, Plus
} from 'lucide-react';
  ...
  return (
    <div className="min-h-[100dvh] bg-background">
      <div className="relative h-28 bg-gradient-to-br from-primary/20 via-accent/10 to-primary/5">
        ...
        {/* Upload Video Button (Top Left - Mobile First) */}
        <div className="absolute top-4 left-4 lg:hidden">
          <button
            className="w-9 h-9 rounded-full bg-primary/20 backdrop-blur border border-primary/30 flex items-center justify-center text-primary shadow-[0_0_15px_rgba(255,45,85,0.3)] transition-all active:scale-95"
            onClick={openUpload}
          >
