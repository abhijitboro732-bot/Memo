...
export default function VideoCard({ video, isActive, onCommentClick, onGiftClick, onShareClick }: VideoCardProps) {
  ...
  return (
    ...
    >
      ...
      <button
        className={`absolute top-14 lg:top-4 right-4 z-20 w-8 h-8 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center transition-opacity duration-200 ${
